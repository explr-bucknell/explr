...
export default class NatParkProf extends React.Component {
  ...
  componentWillMount() {
    this.setState({
      uid: this.props.uid ? this.props.uid : this.props.navigate.state.params.uid
    })
  }
              ...
              <View style={styles.header}>
                <View style={styles.textContainer}>
                  <View style={styles.nameContainer}>
                    <Text style={styles.name}>{this.props.navigate.state.params.name}</Text>
                    <Text style={styles.handle}>{this.props.navigate.state.params.description}</Text>
                  </View>
                </View>
